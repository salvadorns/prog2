...
void tablero::ponerBarco(int l) {
    ...
    do {
        ...
        while (Condicion) {
            ...
            if (x + l - 1 < 10 and x - l + 1 > 0) {
                ...
                cout << "Tu barco no entra en el tablero, ingresa una posicion nueva. Recuerda que tu barco mide " << l
                     << endl;
    ...
    while (Condicion) {
        cout
                << "Ingrese 1 si quiere ir arriba, 2 si quiere ir abajo, 3 si quiere ir a la derecha y 4 si quiere ir abajo. ";
        cin >> eleccion;
        switch (eleccion) {
            case 1:
